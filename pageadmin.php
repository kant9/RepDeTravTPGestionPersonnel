                            ...
                            <ul>
                             ...
                             <li>
                                ...
                                <ul>
                                  ...
                                  <li class="sub-item">
                                    <a href="Pageconnexion.php"><span class="material-icons-outlined"> logout </span>
                                    <p>Déconnexion</p></a>
                                  </li>
                                </ul>
                              </li>
                    ...
                    <div class="card mt-5">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="pageModif.php?id=<?= $person->id ?>" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                <a onclick="return confirm('Etes vous sûr de vouloir archiver cette personne?')" href="delete.php?id=<?= $person->id ?>" class='btn btn-danger'><i class="fa fa-archive" aria-hidden="true"></i></a>
                                <a href="changeRole.php?id=<?= $person->id ?>" class="btn btn-info"><i class="fa fa-exchange" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
