    ...
    <div id="contenantBloc">
        ...
        <div id="hautEtCentr">
            ...
            <div id="centre">
                ...
                <?php
                    require 'bdd.php';
                    $sql = 'SELECT * FROM personnel where etat=1';
                    $ins = $pdo->prepare($sql);
                    $ins->execute();
                    $people = $ins->fetchAll(PDO::FETCH_OBJ);
                    ?>
                    ...
                    <div class="card mt-5">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?= $person->roles; ?></td>
                                <td><?= $person->dateArchivage; ?></td>
                                <td>
                                <a href="restorer.php?id=<?= $person->id ?>" class="btn btn-info"><i class="fa fa-undo" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </table>
